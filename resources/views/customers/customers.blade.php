...
@section('content')
    <div class="container">
        ...
        {{--  <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">担当の顧客</div>  --}}
        <div class="row">
            @foreach ($employee_customers as $employee_customer)
                <div class="col-3 mb-3">
                    <div class="card">
                        ...
                        <a href="{{ route('customer', [$employee_customer->id]) }}" class="stretched-link"></a>
                    </div>
                </div>
            @endforeach
        </div>
